...
public class IFCranePosX implements Runnable 
{
	...
	public IFCranePosX(int myInterval) 
	{
	...
	public IFCranePosX(String myFile, int myInterval) 
	{
		this.timestamp = new Timestamp(System.currentTimeMillis());
		this.curYYYY = this.sdfYYYY.format(this.timestamp);
		this.curMM = this.sdfMM.format(this.timestamp);
    		...
    		if( -1 < iFirst && iFirst < 9 )
    		{
    			...
    			if( "1".equals( this.arryTmpCraneInfo[iFirst][16] ) )
    			{
    				...
    				)
    				{
		    	    	...
		    	    	try
		    	    	{
		    	    		this.printLine(this.isViewYn, "[Sending...(1) "+ this.Poscoict_Svr_Ip +":"+ this.Poscoict_Svr_Port +"] >>>> " + sendSb.toString() );
		    				...
		    				this.printLine(this.isViewYn, "[Sending...(2) "+ this.Poscoict_Svr_Ip_2 +":"+ this.Poscoict_Svr_Port_2 +"] >>>> " + sendSb.toString() );
    ...
    public static void main(String args[])
	{
		...
		IFCranePosX ifm = new IFCranePosX(150);
